...
public class BotMotor : MonoBehaviour
{
    ...
    [SerializeField]
    private float rotationXLimitMax = 85f;
    [SerializeField]
    private float rotationXLimitMin = -85f;
    ...
    private void PerformRotation()
    {
        ...
        currentRotationX += rotationX + shootingMotionY;
        currentRotationX = currentRotationX > rotationXLimitMax ? rotationXLimitMax : currentRotationX;
        currentRotationX = currentRotationX < rotationXLimitMin ? rotationXLimitMin : currentRotationX;

        firespot.transform.localEulerAngles = new Vector3(currentRotationX, 0, 0);
    }
    ...
    public void SetFirespot (GameObject firespot)
    {
